  ...
  return (
    <div className="main ">
          ...
          <div className="bg-blue-50 font-sans  leading-none">
            ...
            <div className="ml-24">
              ...
              <div className=" flex gap-10 ">
                <button className="py-4 text-white px-6 bg-gradient-to-b from-[#0043B7] to-[#001E51] flex gap-2">
                  Learn How It Works
        ...
        <div className="flex  gap-10 items-center">
          <div className="w-full">
            ...
            <div className="mt-8 space-y-10">
              <div className="flex items-start gap-3 hover:shadow-xl w-3/5 p-4 cursor-pointer">
      ...
      <div>
        <CirquraMarquee />
        <div className="flex">
          <div className="w-1/3 h-[38rem] relative group ">
            <img
